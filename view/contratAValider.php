				...
				<?php
					foreach ($contrats as $contrat)
					{
						...
						<tr>
							...
							<td><?php echo $contrat['refMission'];?></td>
							
							<?php if($estAdmin){
								?>
							<td><a href="../Controller/controlContratValider.php?refMi=<?php echo $contrat['refMission']?>&amp;idInt=<?php echo $contrat['idInterim']?>" class="btn btn-info" > Valider </a></td>
					<?php } ?>
					<td><a href="../Controller/controlContratAnnuler.php?refMi=<?php echo $contrat['refMission']?>&amp;idInt=<?php echo $contrat['idInterim']?>" class="btn btn-danger" > Annuler </a></td>
					</tr> 
				<?php	} ?>
